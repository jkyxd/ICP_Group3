    ...
    def create_map(selected_truck_ids):
            ...
            if selected_truck_ids:
                    ...
                    for selected_truck_id in selected_truck_ids:
                            ...
                            colors = ['darkred', 'lightgreen', 'purple', 'gray', 'lightblue', 'white', 'cadetblue', 'darkgreen', 'orange', 'pink', 'blue', 'darkblue', 'lightgray', 'beige', 'black']
                    ...
                    for selected_truck_id in selected_truck_ids:
                            ...
                            # Add the rest of the data as before
